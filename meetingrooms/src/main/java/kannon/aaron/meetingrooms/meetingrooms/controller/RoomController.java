...
public class RoomController {
    ...
    @PutMapping("/{id}")
    public MessageResponseDTO updateById(@PathVariable Long id, @RequestBody @Valid Room personDTO) throws RoomNotFoundException {
        return roomService.updateById(id, personDTO);
    }
